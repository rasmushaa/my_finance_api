...
class ErrorCode(Enum):
    """Standardized error codes for API responses to facilitate consistent error
    handling by clients."""
...
class ErrorResponse(BaseModel):
    ...
    This model aligns with FastAPI's error response structure, allowing us to return
...
class CustomHTTPException(HTTPException):
    ...
    This class allows us to raise HTTP exceptions with a consistent error response
    structure defined by the ErrorDetail model.
    """
    ...
    def __init__(
        ...
        error_detail = ErrorDetail(
            code=error_code.value, message=message, detail=details
        )
